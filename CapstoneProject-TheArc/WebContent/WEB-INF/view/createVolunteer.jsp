    ...
    <div id="member">
    	<form>
    	   ...
    	   <div class="lable">
    	      ...
    	      <div class="col_1_of_3 span_1_of_3"><input type="text" class="text" name="VolunteerFlag" value="Volunteer Flag" onfocus="this.value = '';" onblur="if (this.value == '') {this.value = 'CurrentVolunteerFlag';}"></div>
    	      <div class="clear"> </div>
    	   </div>
    	   ...
    	   <div class="submit">
    		  <input type="submit" onclick="myFunction()" value="Create Volunteer" >
    	   </div>
    	   <div class="clear"> </div>
    	</form>
    </div>
